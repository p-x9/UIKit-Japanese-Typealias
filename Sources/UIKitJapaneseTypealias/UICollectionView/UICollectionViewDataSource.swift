...
public protocol コレクションビューデータソース: AnyObject {
    ...
    func コレクションビュー(_ コレクションビュー: コレクションビュー, セル インデックスパス: インデックスパス) -> コレクションビューセル
    
    func セクション数(コレクションビュー: コレクションビュー) -> 整数
    
    func コレクションビュー(_ コレクションビュー: コレクションビュー, 補足ビュー 種類: 文字列, インデックスパス: インデックスパス) -> コレクション再利用可能ビュー
    
    func コレクションビュー(_ コレクションビュー: コレクションビュー, 移動可能か インデックスパス: インデックスパス) -> 真理値
    
    func コレクションビュー(_ コレクションビュー: コレクションビュー, 行を移動 移動元インデックスパス: インデックスパス, 移動先インデックスパス: インデックスパス)
    
    @available(iOS 14.0, *)
    func セクションインデックスのタイトル(コレクションビュー: コレクションビュー) -> [文字列]?
    
    @available(iOS 14.0, *)
    func コレクションビュー(_ コレクションビュー: コレクションビュー, インデックスタイトルに対するインデックスパス タイトル: 文字列, インデックス: 整数) -> インデックスパス
}
