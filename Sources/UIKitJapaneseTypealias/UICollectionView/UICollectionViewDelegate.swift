...
public protocol コレクションビュー委譲: NSObjectProtocol {
    ...
    func コレクションビュー(_ コレクションビュー: コレクションビュー, アイテムがハイライトされた後 インデックスパス: IndexPath)
    
    func コレクションビュー(_ コレクションビュー: コレクションビュー, アイテムのハイライトが解除された後 インデックスパス: IndexPath)
    
    func コレクションビュー(_ コレクションビュー: コレクションビュー, アイテムを選択するべきか インデックスパス: IndexPath) -> 真理値
    
    func コレクションビュー(_ コレクションビュー: コレクションビュー, アイテムの選択を解除するべきか インデックスパス: IndexPath) -> 真理値
    
    func コレクションビュー(_ コレクションビュー: コレクションビュー, アイテムが選択された後 インデックスパス: IndexPath)
    
    func コレクションビュー(_ コレクションビュー: コレクションビュー, アイテムの選択が解除された後 インデックスパス: IndexPath)
    
    func コレクションビュー(_ コレクションビュー: コレクションビュー, セルが表示される前 セル: コレクションビューセル, インデックスパス: IndexPath)
    
    func コレクションビュー(_ コレクションビュー: コレクションビュー, 補足ビューが表示される前 ビュー: コレクション再利用可能ビュー, 種類: 文字列, インデックスパス: IndexPath)
    
    func コレクションビュー(_ コレクションビュー: コレクションビュー, セルの表示が終わった後 セル: コレクションビューセル, インデックスパス: IndexPath)
    
    func コレクションビュー(_ コレクションビュー: コレクションビュー, 補足ビューの表示が終わった後 ビュー: コレクション再利用可能ビュー, 種類: 文字列, インデックスパス: IndexPath)
    
    @available(iOS, introduced: 6.0, deprecated: 13.0)
    func コレクションビュー(_ コレクションビュー: コレクションビュー, メニューを表示するべきか インデックスパス: IndexPath) -> 真理値
    
    @available(iOS, introduced: 5.0, deprecated: 13.0)
    func コレクションビュー(_ コレクションビュー: コレクションビュー, アクションを実行可能か セレクタ: Selector, インデックスパス: IndexPath, センダ: Any?) -> 真理値
    
    @available(iOS, introduced: 5.0, deprecated: 13.0)
    func コレクションビュー(_ コレクションビュー: コレクションビュー, アクションを実行 セレクタ: Selector, インデックスパス: IndexPath, センダ: Any?)
    
    func コレクションビュー(_ コレクションビュー: コレクションビュー, レイアウトを遷移 元レイアウト: コレクションビューレイアウト, 先レイアウト: コレクションビューレイアウト) -> コレクションビュー遷移レイアウト
    
    func コレクションビュー(_ コレクションビュー: コレクションビュー, アイテムをフォーカス可能か インデックスパス: IndexPath) -> 真理値
    ...
    func 優先的にフォーカスされるビュー(コレクションビュー: コレクションビュー) -> IndexPath?
    
    @available(iOS 15.0, *)
    func コレクションビュー(_ コレクションビュー: コレクションビュー, アイテムフォーカス時に自動で選択するか インデックスパス: IndexPath) -> 真理値
    
    @available(iOS 15.0, *)
    func コレクションビュー(_ コレクションビュー: コレクションビュー, 移動元インデックスパス: IndexPath, 現在のインデックスパス: IndexPath,  提案する移動先インデックスパス: IndexPath) -> IndexPath
    
    @available(iOS, introduced: 9.0, deprecated: 15.0)
    func コレクションビュー(_ コレクションビュー: コレクションビュー, 移動元インデックスパス: IndexPath, 提案する移動先インデックスパス: IndexPath) -> IndexPath
    
    func コレクションビュー(_ コレクションビュー: コレクションビュー, 提案するコンテンツオフセット: 位置) -> 位置
    
    @available(iOS 14.0, *)
    func コレクションビュー(_ コレクションビュー: コレクションビュー, アイテムを編集可能か インデックスパス: IndexPath) -> 真理値
    
    @available(iOS 13.0, *)
    func コレクションビュー(_ コレクションビュー: コレクションビュー, コンテキストメニュー設定 インデックスパス: IndexPath, 位置: 位置) -> コンテキストメニュー設定?
